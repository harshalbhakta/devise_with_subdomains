...
wayne_enterprises = App.create!(name: "Wayne Enterprises", owner_id: bruce_wayne.id, subdomain: "wayneenterprises")

tony_stark = User.create!(name: "Tony Stark", email: "tony@starkindustries.com", password: "pepper")
stark_industries = App.create!(name: "Stark Industries", owner_id: tony_stark.id, subdomain: "starkindustries")
